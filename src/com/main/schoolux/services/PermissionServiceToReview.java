...
public class PermissionServiceToReview {


    /////////////
    // LOGGER
    private final static Logger LOG = Logger.getLogger(PermissionServiceToReview.class);
    ...
    public PermissionServiceToReview() {
    }
    ...
    public PermissionServiceToReview(EntityManager em) {
        this.em = em;
    }
    ...
    public PermissionEntity selectOnePermissionById(int id) {
