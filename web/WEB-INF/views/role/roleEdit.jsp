    ...
    <form method="post"  action="${pageContext.request.contextPath}/role" >
        ...
        <div class="form-row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control is-valid" id="validationServer01" name ="labelFromForm" value="${requestScope.myRoleVMRequestKey.label}" required  minlength="5" maxlength="100">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control is-valid" id="validationServer02"  name ="abbreviationFromForm" value="${requestScope.myRoleVMRequestKey.abbreviation}"  required minlength="6" maxlength="10">
                <div class="valid-feedback">
                    Looks good!
                </div>
        ...
        <div class="form-row">
            <div class="col-md-12 mb-6">
                ...
                <input type="text" class="form-control is-invalid" id="validationServer03" name ="descriptionFromForm" value="${requestScope.myRoleVMRequestKey.description}" aria-describedby="validationServer03Feedback"  maxlength="2000" >
